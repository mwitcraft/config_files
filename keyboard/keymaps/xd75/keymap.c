 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | ESC    | A      | S      | D      | F      | G      | HOME   | SCROLL | END    | H      | J      | K      | L      | ;      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | DELETE | UP     | INSERT | N      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | PGDN   | PRSC   | LALT   | Super  | Super  | LEFT   | DOWN   | RIGHT  | SPACE  | SPACE  | RALT   | FN     | PGUP   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_SLCK,  KC_END, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL,  KC_UP,   KC_INS, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT  },
  { KC_LCTL, KC_PGDN, KC_PSCR, KC_LALT, KC_LGUI,  KC_RGUI,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  KC_SPC,  KC_RALT, MO(_FN), KC_PGUP, KC_RCTL  },
 },
